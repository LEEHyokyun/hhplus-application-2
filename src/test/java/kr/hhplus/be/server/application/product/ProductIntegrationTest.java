...
public class ProductIntegrationTest {
	...
	@Test
	@DisplayName("[통합테스트] 주문을 하고 결제를 한다.")
	void insertTest() {
		/*
		 * given
		 ...
		 * */
		int originalProductQuantity = 1;
		int originalPoint = 200;
		 ...
		 * - 검증 대상의 동작 하나만 기술한다.
		 * */
		int actualRow = productFacade.orderAndPay(DTO);
		 ...
		 * - 테스트 과정을 종합한다.
		 * */
		assertEquals(expectedProductQuantity, actualRow);
		assertEquals(expectedPoint, actualRow);	
	}
}
